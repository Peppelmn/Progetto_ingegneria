...
//         });
//     visualizza.addEventListener("click", () => {
//         let urlPattern = `http://localhost:1337/api/patterns?fields[5]=Nome&filters[gdpr_articles][Numero][$eq]=${select.value}`;
//         let text = "";
//         fetch(urlPattern)
//             .then(response => response.json())
//             .then(funzione2 => {
